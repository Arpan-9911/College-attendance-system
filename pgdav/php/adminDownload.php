          ...
          <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                <form method="post" action="adminDownloadTheory.php">
                  ...
                  <div class="form-group mb-2">
                    <label for="exampleInputName" class="m-0">Teacher Name</label>
                    <div class="input-group">
                      <div class="input-group-prepend bg-transparent">
                        <span class="input-group-text bg-transparent border-right-0">
                          <i class="ti-book text-primary"></i>
                      ...
                      <input type="text" name="theoryTeacher" class="form-control form-control-lg border-left-0" id="exampleInputName" required>
                    </div>
                  </div>
                  <div class="form-group mb-2">
          ...
          <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                <form method="post" action="adminDownloadPrac.php">
                  <div class="form-group mb-2">
                    <label for="exampleInputSubject" class="m-0">Subject</label>
                    <div class="input-group">
                      <div class="input-group-prepend bg-transparent">
                  ...
                  <div class="form-group mb-2">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" name="pracTeacher" class="form-control form-control-lg border-left-0" id="exampleInputName" required>
                    </div>
                  </div>
                  <div class="form-group mb-2">
                    <label for="exampleInputTime" class="m-0">Time Period</label>
