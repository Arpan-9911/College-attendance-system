...
$dateQuery = "SELECT DISTINCT DATE(date) AS attendanceDate FROM `attendance` WHERE teacherName = '$staffName' AND subject = '$subject' AND period = 'Theory-1' ORDER BY attendanceDate ASC";
...
$filename = $subject . '-theory-semester.xlsx';
